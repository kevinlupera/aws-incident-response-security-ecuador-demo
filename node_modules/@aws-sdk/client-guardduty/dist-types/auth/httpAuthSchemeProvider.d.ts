...
import { type GuardDutyClientResolvedConfig } from "../GuardDutyClient";
/**
 * @internal
 */
 ...
 * @internal
 */
export interface GuardDutyHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<GuardDutyClientResolvedConfig, HandlerExecutionContext, GuardDutyHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultGuardDutyHttpAuthSchemeParametersProvider: (config: GuardDutyClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<GuardDutyHttpAuthSchemeParameters>;
/**
 * @internal
 */
