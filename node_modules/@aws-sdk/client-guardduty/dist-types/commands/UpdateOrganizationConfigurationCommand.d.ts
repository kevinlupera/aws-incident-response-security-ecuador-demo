...
import type { UpdateOrganizationConfigurationRequest, UpdateOrganizationConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateOrganizationConfigurationCommand_base: {
    new (input: UpdateOrganizationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateOrganizationConfigurationCommandInput, UpdateOrganizationConfigurationCommandOutput, GuardDutyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateOrganizationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateOrganizationConfigurationCommandInput, UpdateOrganizationConfigurationCommandOutput, GuardDutyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
